...
if (!empty($_POST)) {
    ...
    $sql="insert into employee(name,gender,birthdate,department,remarks) value('$name','$gender','$birthdate','$department','$remarks')";
    $result=@mysqli_query($link,$sql) or exit ('添加失败'.mysqli_error($link));
    header('location:./showList.php');   
}
