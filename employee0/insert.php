...
if (!empty($_POST)) {
    ...
    $file = $_FILES['picture'];
    if ($file['error'] == 4) {
        $newname = './uploads/default.jpg';
    } else {
        $newname = upload($file);
    }
    
    $sql = "insert into employee(name, gender, birthdate, department, picture, remarks) values('$name', '$gender', '$birthdate', '$department', '$newname', '$remarks')";
                        ...
                        <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><input name="picture" id="" type="file">
                            </tr>
                            <tr>
                                <th>备注：</th>
