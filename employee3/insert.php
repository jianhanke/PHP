<?php
  ...
  if (!empty($_POST)) {
    ...
    $sql = "insert into employee (name, picture,gender, birthdate, department, remarks) values('$name','$save','$gender', 
    '$birthdate', '$department', '$remarks') ";
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>照片</th>  <!-- <th>是加粗</th>  -->
                                <td> 
                                    <input type="file" name="picture" align="left">
