...
<body>
	...
	<table>
		...
		<caption>这是最顶部</caption>
		<caption>不管有多少字体，都是在中间</caption>
		<tr><th>商品名称</th><th>单价</th><th>产地</th><th>数量</th><th>总价</th></tr>
		<?php foreach($goods as $k => $v): ?>
			<tr>
				...
				<td><?php $money = $v['price'] * $_POST[$k];echo $money;$total +=$money;?></td>
			</tr>
